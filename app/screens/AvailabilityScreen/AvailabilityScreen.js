...
class AvailabilityScreen extends AgentScreen {
  ...
  onSelectStart = (weekDay: DayType) => {
    this.setState({ isStartSelected: true, currentWeekday: weekDay });
    this.showDateTimePicker();
  };

  onSelectEnd = (weekDay: DayType) => {
    this.setState({ isStartSelected: false, currentWeekday: weekDay });
    this.showDateTimePicker();
  };
  ...
  hideDateTimePicker = () => {
    ...
    this.setState({ isStartSelected: undefined, currentWeekday: undefined });
  };
        ...
        <GradientHeader>
          ...
          <ScrollView>
            <Card style={styles.availabilityCard}>
              ...
              <DayCircles onPressCircle={this.onPressCircle} days={circleDays} />
              <TimeSlots
                slots={availability}
                onSelectStart={this.onSelectStart}
                onSelectEnd={this.onSelectEnd}
              />
              <Button title="SAVE" color={Colors.primary} onPress={this.onSavePressed} />
            </Card>
          </ScrollView>
        </GradientHeader>
      </Container>
