      ...
      serviceRatings.length > 0 ? (
        ...
        <View style={styles.nullMessageContainer}>
          ...
          <Text scale={Text.Scale.BODY}>
            Looks like this service does not have any reviews yet
          </Text>
        </View>
      );
    const offeringsPrompt = _.isEmpty(offerings) ? (
      <View>
        <Text scale={Text.Scale.SUBTITLE}>
          Have fixed prices and durations for this service?
        </Text>
      ...
      <View>
        <View style={styles.viewOfferingCaptionContainer}>
          <Text scale={Text.Scale.CAPTION}>
            Offerings have fixed prices and durations
          </Text>
        </View>
        <Button
          title="View Offerings"
          onPress={this.navigateToOfferingListScreen}
        />
      </View>
    );
    return (
          ...
          <GradientHeader>
            ...
            <View style={styles.offeringsContainer}>
              <View style={styles.offeringsHeadingContainer}>
                <SectionHeading
                  text="Offerings"
                  onAddPressed={this.addOfferings}
                />
                <View style={styles.offeringsPromptContainer}>
                  {offeringsPrompt}
                </View>
              </View>
            </View>
