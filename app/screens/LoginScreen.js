...
function LoginScreen(props: Props) {
  ...
  useEffect(() => {
    ...
    allCategoriesSubscription = contentManager.allCategories$.subscribe(newCategories => {
  ...
  const toggleShuffle = () => {
    setShuffle(prevShuffle => ({ shuffle: !prevShuffle }));
  };
    ...
    try {
      ...
      switch (error.name) {
        ...
        case AuthStatus.COGNITO.NOT_AUTHORIZED_ERROR:
          AlertUtils.showSnackBar("Incorrect password & email combination", Colors.secondary);
          break;
        case AuthStatus.COGNITO.USER_NOT_FOUND_ERROR:
          AlertUtils.showSnackBar("There are no agents with that email", Colors.secondary);
          break;
        default:
          console.log(error);
      ...
      <Container style={styles.container}>
        ...
        <View style={styles.loginContainer}>
          ...
          <View style={styles.btnContainer}>
            <Button isDisabled={isLoginPressed} title="Login" onPress={onLoginPressed} />
            <OrDivider />
            <Button
