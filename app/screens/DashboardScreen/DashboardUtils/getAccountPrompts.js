...
const getAccountPrompts = (agent: Agent, navigation: NavigationScreenProp<any, any>): Prompt[] => {
  const prompts: Prompt[] = [
    {
      ...
      onPrimaryActionPressed: () => {
        navigation.navigate({
          ...
          params: { shouldSetProfilePicture: true },
        });
      },
      onDiscardPressed: () => {},
    },
    {
      ...
      onPrimaryActionPressed: () => {
        navigation.navigate({
          routeName: "AccountScreen",
          params: { shouldSetBusinessName: true },
        });
      },
      onDiscardPressed: () => {},
    },
  ...
  return prompts
    .filter(prompt => agent[prompt.field] === undefined || agent[prompt.field] === "")
    .slice(0, 3);
};
